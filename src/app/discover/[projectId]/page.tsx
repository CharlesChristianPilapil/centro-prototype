...
const page = () => {
  ...
  const contractId = pathname.split("/discover/")[1];
      ...
      <div className="w-[60%]">
        ...
        >
          {projectDetails?.details?.map((item) => (
            <ProjectDetailCard leftData={item[0]} rightData={item[1]} />
          ))}
        </CardLayout>
        <CardLayout
        ...
        >
          <div className="grid grid-cols-2 mb-4 border-2 rounded-b-lg border-gray-500">
            <div>
              ...
              <p className="px-[10px] py-[5px]">{"John De Leon"}</p>
              <p className="px-[10px] py-[5px]">{"Jane Dela Cruz"}</p>
              <p className="px-[10px] py-[5px]">{"Charles Santos"}</p>
              <p className="px-[10px] py-[5px]">{"Emily Carranza"}</p>
            </div>
            <div>
              <p
              ...
              <p className="px-[10px] py-[5px]">{"Project Engineer"}</p>
              <p className="px-[10px] py-[5px]">{"Materials Engineer"}</p>
              <p className="px-[10px] py-[5px]">{"Site Engineer"}</p>
              <p className="px-[10px] py-[5px]">{"Project Coordinator"}</p>
            </div>
          </div>
        </CardLayout>
      </div>
